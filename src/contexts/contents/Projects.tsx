...
export const ProjectsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  const [projects, setProjects] = useState<{ 
    ...
    Anti_Tetris: {
      ...
      description: `Developed a two-player Tetris game with \\React\\ and \\Next.js\\ using browser-based timers to update game states.\nDeployed a WebSockets (\\Socket.IO + Express.js\\) server to handle multiplayer sessions with \\<30 ms\\ latency.`,
      languages: ["react", "javascript", "node", "express","html","css"],
      award: ["logo/firstplace.png", "First Place", "award-gold"],
      links: {
        Github: "https://github.com/enxilium/antitetris",
